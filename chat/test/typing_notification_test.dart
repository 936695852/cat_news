...
void main() {
  ...
  late TypingNotification sut; // system under test
  ...
  test('send typing notification successfully', () async {
  ...
  test('successfully subscribe adn receive typeing events', () async {
